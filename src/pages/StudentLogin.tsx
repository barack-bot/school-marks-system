...
import { getStudentByAdmission } from "../services/userService";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (studentError || !student) {
        setError("Student not found or invalid credentials");
        return;
      }

      // In a real app, you'd verify the password here
      // For now, we'll use a simple mock (admission number as password)
      if (password !== "password123" && password !== admissionNumber) {
